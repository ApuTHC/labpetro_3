...
var volcanesIcon = new L.Icon({
  iconUrl: '../images/geomap/icons/icon-volcan.png',
  iconSize: [50, 50],
  iconAnchor: [25, 50],
  popupAnchor: [0, -50]
});
...
function cargarlado() {
  ...
  $("#macro2").attr('src' , 'images/geomap/' + mark2.cod + '/macrozoom.jpg');
  $("#micronll").attr('src' , 'images/geomap/' + mark2.cod + '/micronll.jpg');
  $("#micronx").attr('src' , 'images/geomap/' + mark2.cod + '/micronx.jpg');
...
////////////////////////////////////////////Funciones botones de sidebar

$(".btn-services").click(function (e) { 
  e.preventDefault();
  $('body').attr('class','der');
  sidebarControl('services');
...
function sidebarControl(btn) {
  if (btn=='services') {
    if ($('.btn-services').hasClass('active')) {
